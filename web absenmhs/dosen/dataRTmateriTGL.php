            ...
            <div class="card-header bg-white">
                ...
                <center><div class="btn-group mt-2 mb-2" role="group" aria-label="Basic example">
                   <!-- <a href="dataTanggal.php" class="btn btn-primary">Lihat Data Berdasarkan Tanggal</a>
                    ...
                    <a href="#" class="btn btn-primary">---- DATA REALTIME ABSENSI MAHASISWA MATAKULIAH (<?php echo $materi; ?>) BERDASARKAN TANGGAL ----</a>
                </div></center>
            ...
            <div class="card-body bg-white">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                        include('koneksi.php');
                        $member = mysqli_query($koneksi, "SELECT DISTINCT tanggal FROM data WHERE materi='$materi'");
                        $no = 1;
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="dataRTmateriVIEW.php?materi=<?php echo $materi; ?>&tanggal=<?php echo $row['tanggal']; ?>" class="btn btn-sm btn-primary">Lihat Data</a>
                                    </td>
                                </tr>
                            </tbody>
                        <?php } ?>
