    ...
    <div class="container">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
               ...
               <h3 class="text-center">Data Absensi Mahasiswa Anda</h3>
                ...
                <center><div class="btn-group mt-2 mb-2" role="group" aria-label="Basic example">
                 ...
                 <a href="#" class="btn btn-primary">---- DATA REALTIME ABSENSI MAHASISWA ANDA MATAKULIAH (<?php echo $materi; ?>) PADA TANGGAL (<?php echo $tanggal; ?>) ----</a>
               </div></center>
            ...
            <div class="card-body bg-white">
                ...
                <table class="table table-responsive-sm table-bordered">
                    ...
                    include('koneksi.php');
                    $no = 0;
                    $data   = mysqli_query($koneksi, "SELECT * FROM data WHERE tanggal ='$tanggal' AND materi ='$materi' ");
