...
$jadwal  = mysqli_query($koneksi, "SELECT * FROM krs WHERE tag ='53172109179'");
            ...
            <div class="card-header bg-white">
                ...
                <center><div class="btn-group mt-2 mb-2" role="group" aria-label="Basic example">
                   <!-- <a href="dataTanggal.php" class="btn btn-primary">Lihat Data Berdasarkan Tanggal</a>
                    ...
                    <a href="#" class="btn btn-primary">---- DATA REALTIME ABSENSI ANDA BERDASARKAN MATAKULIAH YANG ANDA AMBIL----</a>
                </div></center>
            ...
            <div class="card-body bg-white">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                        include('koneksi.php');
                        $member = mysqli_query($koneksi, "SELECT* FROM krs WHERE tag='$tag'");
                        $no = 1;
