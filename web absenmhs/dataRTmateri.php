    ...
    <div class="container">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
                <h3 class="text-center">Data Absensi Mahasiswa</h3>
                ...
                <center><div class="btn-group mt-2 mb-2" role="group" aria-label="Basic example">
                   <!-- <a href="dataTanggal.php" class="btn btn-primary">Lihat Data Berdasarkan Tanggal</a>
                    ...
                    <a href="#" class="btn btn-primary">---- DATA REALTIME ABSENSI MAHASISWA BERDASARKAN MATAKULIAH ----</a>
                </div></center>
            ...
            <div class="card-body bg-white">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <?php
                        include('koneksi.php');
                        $member = mysqli_query($koneksi, "SELECT DISTINCT materi FROM krs");
                        $no = 1;
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="dataRTmateriTGL.php?materi=<?php echo $row['materi']; ?>" class="btn btn-sm btn-primary">Lihat Berdasarkan Tanggal</a>
                                    </td>
                                </tr>
                            </tbody>
                        <?php } ?>
